...
import { joinURL, hasProtocol, isEqual, withLeadingSlash, parseURL, encodeParam, encodePath } from "ufo";
...
const layouts = {
  default: vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/default.3f097766.js"))
};
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<nav${ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex gap-10" }, _attrs))}>`);
  ...
  _push(ssrRenderComponent(_component_Nuxt_link, { to: "/myprofile" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`\uB0B4 \uD504\uB85C\uD544`);
      } else {
...
const routes = [
  {
    ...
    component: () => import("./_nuxt/404.4a25841b.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.7763f650.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    component: () => import("./_nuxt/login.036ab475.js").then((m) => m.default || m)
  },
  {
    name: "lostpassword",
    path: "/lostpassword",
    ...
    component: () => import("./_nuxt/lostpassword.d031700b.js").then((m) => m.default || m)
  },
  {
    name: "myprofile",
    path: "/myprofile",
    ...
    component: () => import("./_nuxt/myprofile.59055078.js").then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    ...
    component: () => import("./_nuxt/register.2bb2acad.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/error-component.40dcbef7.js"));
    const nuxtApp = useNuxtApp();
