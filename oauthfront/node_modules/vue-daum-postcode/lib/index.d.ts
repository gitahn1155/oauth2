...
export declare function install(app: App, { name, ...options }?: VueDaumPostcodeInstallOptions): void;
declare const plugin: Plugin;
export { plugin as default, createVueDaumPostcode, CreateVueDaumPostcodeOptions, VueDaumPostcodeTheme, VueDaumPostcode, VueDaumPostcodeCompleteResult, VueDaumPostcodeSearchResult, VueDaumPostcodeResizeResult, };
