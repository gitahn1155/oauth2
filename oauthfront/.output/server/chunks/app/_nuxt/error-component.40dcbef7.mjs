...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.35a7de81.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.c3116c01.mjs'));
...
//# sourceMappingURL=error-component.40dcbef7.mjs.map
